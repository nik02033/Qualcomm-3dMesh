...
```bash
curl -L -J "https://arizonastateu-my.sharepoint.com/personal/nkanodi1_sundevils_asu_edu/_layouts/15/download.aspx?share=EbrD8ayiY2VKvTph3MxWJBcB0HdlMz0SO7kCD8sg_rXSRw" -o sam.tar.gz
```
...
python main_infer.py --images_dir renders   --model_path ./FastSAM/weights/FastSAM.pt   --output_dir outputs   --device cpu
